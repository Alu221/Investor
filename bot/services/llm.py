...
class LLMService:
    ...
    async def _call_claude(self, user_message: str, session_id: str | None = None,
        ...
        tg_fmt = (
            ...
            "ДЛИНА ОТВЕТА ЗАВИСИТ ОТ ВОПРОСА: "
            "простой вопрос (привет, что умеешь, сколько компаний) = 1-3 предложения. "
            "Средний вопрос (что думаешь про Сбер, какие дивиденды) = 500-1000 символов. "
            "Полный анализ (проанализируй, сравни, собери портфель) = до 3000 символов. "
            "Дисклеймер ТОЛЬКО в конце полного анализа, не в коротких ответах. "
